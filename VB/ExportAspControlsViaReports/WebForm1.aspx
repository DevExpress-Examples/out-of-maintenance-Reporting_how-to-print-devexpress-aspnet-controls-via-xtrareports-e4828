	...
	<form id="form1" runat="server">
		<div style="text-align: center; padding: 40px;">
			...
			<div style="height: 230px; vertical-align: middle; text-align: center; width:300px;">
				<dx:ASPxGridView ID="ASPxGridView1" runat="server" DataSourceID="ObjectDataSource1" AutoGenerateColumns="False" Width="315px">
					<Columns>
						<dx:GridViewDataTextColumn FieldName="Name" VisibleIndex="0">
						</dx:GridViewDataTextColumn>
						<dx:GridViewDataTextColumn FieldName="Surname" VisibleIndex="1">
						</dx:GridViewDataTextColumn>
						<dx:GridViewDataTextColumn FieldName="Gendor" VisibleIndex="2">
						</dx:GridViewDataTextColumn>
			...
			<div style="height: 230px; vertical-align: middle;text-align: center; width:300px;">
				<dxchartsui:WebChartControl ID="WebChartControl1" runat="server" CrosshairEnabled="True" DataSourceID="ObjectDataSource1" Height="200px" SideBySideEqualBarWidth="True" Width="315px">
					<diagramserializable>
				<cc1:XYDiagram>
...
<cc1:SolidFillOptions></cc1:SolidFillOptions>
					...
					<seriesserializable>
				<cc1:Series ArgumentDataMember="Name" ArgumentScaleType="Qualitative" Name="Age" ValueDataMembersSerializable="Age">
					<viewserializable>
...
<cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
			...
			<div style="height: 60px; vertical-align: middle; text-align: center; width:300px;">
				<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Export to PDF" Width="136px" />
			</div>

			<dx:ASPxGridViewExporter ID="ASPxGridViewExporter1" runat="server" GridViewID="ASPxGridView1">
			</dx:ASPxGridViewExporter>
			<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="ExportAspControlsViaReports.WebForm1"></asp:ObjectDataSource>
